...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    'settings.emp_profile': 'Profile',
    'settings.emp_desc': 'Your Private Account & Preferences',
    'settings.emp_btn': 'Edit Profile Details',
    'settings.confidential_title': '100% Confidential',
    'settings.confidential_body': 'Your reflections, messages, mood logs, and journal entries are strictly private. Itoura is a secure, judgment-free zone designed solely for your mental wellbeing.',
    ...
    'onboarding.p2_desc': '100% confidential. No one else can read your messages or access your private data.',
  ...
  pcm: {
    ...
    'settings.local_storage': 'Privacy & Local Storage',
    'settings.emp_profile': 'Profile',
    'settings.emp_desc': 'Your Private Account & Settings',
    'settings.emp_btn': 'Edit Profile Details',
    'settings.confidential_title': '100% Secret & Safe',
    'settings.confidential_body': 'Nobody fit read your chat or journal. Itoura na 100% private place for only you.',
    ...
    'onboarding.p2_title': 'Private by Default',
    'onboarding.p2_desc': '100% confidential. Nobody else fit see your chat.',
  ...
  yo: {
    ...
    'settings.emp_profile': 'Profile',
    'settings.emp_desc': 'Àkọsílẹ̀ àti Ètò Àpù Rẹ',
    'settings.emp_btn': 'Àtúnṣe Àkọsílẹ̀',
    'settings.confidential_title': '100% Àṣírí',
    'settings.confidential_body': 'Ẹnikẹ́ni kò le ka awọn ọ̀rọ̀ rẹ tabi ri àkọsílẹ̀ rẹ. Aaye àbò pátápátá ni Itoura jẹ́.',
  ...
  ha: {
    ...
    'settings.emp_profile': 'Profile',
    'settings.emp_desc': 'Bayanin Akauntin ku na Sirri',
    'settings.emp_btn': 'Gyara Bayanin Akaunti',
    'settings.confidential_title': '100% Sirri',
    'settings.confidential_body': 'Babu wanda zai iya karanta sakonninka ko littafinka. Itoura wuri ne mai aminci na kanka kadai.',
    ...
    'onboarding.p2_desc': '100% sirri. Babu wanda zai iya ganin bayananka.',
  ...
  ig: {
    ...
    'settings.emp_profile': 'Profile',
    'settings.emp_desc': 'Akaụntụ na Ntọala Rịba ama Gị',
    'settings.emp_btn': 'Nọgide na Akaụntụ Gị',
    'settings.confidential_title': '100% Nzuzo Nchedo',
    'settings.confidential_body': 'Enweghị onye ọzọ nwere ike ịgụ ozi gị ma ọ bụ hụ ihe ị dere. Nke a bụ ebe nchedo gị kpam kpam.',
    ...
    'onboarding.p2_desc': 'Enweghị onye ọzọ nwere ike ịhụ ihe ị dere.',
