...
export default function HomePage() {
  return (
    <div className="h-full flex flex-col max-w-4xl mx-auto space-y-4">
      ...
      >
        {/* Ambient Glow Orbs */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-[#C4B4E2]/20 rounded-full blur-2xl pointer-events-none"></div>
        ...
        <div className="relative z-10 my-1 px-8 py-3 md:px-14 md:py-4 inline-flex flex-col items-center justify-center">
          ...
          {/* Prominent High-Visibility Orbital Ring SVG */}
          <svg 
            className="absolute inset-0 w-full h-full pointer-events-none overflow-visible stroke-[#C4B4E2] drop-shadow" 
            viewBox="0 0 440 160" 
