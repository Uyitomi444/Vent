...
const clientA = mqtt.connect(brokerUrl, { clientId: 'clientA_' + Math.random().toString(16) });
const clientB = mqtt.connect(brokerUrl, { clientId: 'clientB_' + Math.random().toString(16) });
